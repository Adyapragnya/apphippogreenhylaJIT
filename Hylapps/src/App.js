...
import MyChatIcon from "./assets/images/frog.gif"; // Import your custom GIF
import { Fab } from "@mui/material"; // Import Fab for floating button
import ChatBot from "layouts/ChatBot/ChatBot"; // Import the ChatBot component
...
export default function App() {
  ...
  const toggleChatBot = () => setChatBotOpen(!isChatBotOpen); // Toggle chatbot modal
...
<Fab
      ...
      >
         <img src={MyChatIcon} alt="ChatBot" style={{ width: "50px", height: "50px" }} />
      </Fab>
